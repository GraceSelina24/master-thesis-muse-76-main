        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="age" value={profile.age} readOnly />
            </div>
            <div className="space-y-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="height" value={profile.height} readOnly />
            </div>
            <div className="space-y-2">
              <Label htmlFor="weight">Weight ({profile.weightUnit})</Label>
              <Input id="weight" value={profile.weight} readOnly />
            </div>
            <div className="space-y-2">
              <Label htmlFor="activityLevel">Activity Level</Label>
              <Input id="activityLevel" value={profile.activityLevel} readOnly />
            </div>
          </CardContent>
        </Card>
